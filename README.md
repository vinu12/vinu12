...
Skills: PHP7, PHP8,Node.js, Nest.js Express.js Laravel, zend cakephp codeignitor, Magento prstashop, wordpress, ajax jquery AWS ,GC, Jest, Webpack · REST APIs · Cascading Style Sheets (CSS) · redux · React.js · JavaScript · HTML · GitHub, SVN
